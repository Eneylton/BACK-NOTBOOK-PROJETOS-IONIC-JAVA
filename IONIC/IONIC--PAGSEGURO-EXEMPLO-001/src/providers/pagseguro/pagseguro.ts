...
export class Dados {
  public id: number;
  public nome: string = 'Eneylton de Jeus Campos Barros';
  public telefone: string = '(98) 98991581962';
  public email: string = 'c03735392781046627027@sandbox.pagseguro.com.br';
  public cpf: string = '64326764368';
  public nascimento: string = '27/09/1979';
  public logradouro: string = 'Rua 03 Qd.05 ';
  public numero: string = '36';
  public bairro: string = 'Cohatrac IV';
  public cep: string = '45002-055';
  public cidade: string = 'São Luís';
  public estado: string = 'ma';
